...
export const emulator_adc_get: (a: number, b: number) => number;
export const emulator_adc_set: (a: number, b: number, c: number) => void;
...
export const emulator_dma_status: (a: number) => number;
...
export const emulator_flash_region: (a: number) => [number, number];
...
export const emulator_i2c_read: (a: number, b: number) => number;
export const emulator_i2c_write: (a: number, b: number, c: number) => void;
export const emulator_interrupt: (a: number, b: number, c: number, d: number) => [number, number];
export const emulator_kb_disp: (a: number) => [number, number];
export const emulator_kb_push: (a: number, b: number) => void;
export const emulator_lcd_text: (a: number) => [number, number];
export const emulator_load: (a: number, b: number, c: number, d: number) => void;
export const emulator_load_flash: (a: number, b: number, c: number, d: number) => void;
...
export const emulator_rtc_reg: (a: number, b: number) => number;
...
export const emulator_set_flash: (a: number, b: number, c: number) => void;
export const emulator_set_interrupt_mode: (a: number, b: number) => [number, number];
...
export const emulator_spi_read: (a: number, b: number) => number;
export const emulator_spi_write: (a: number, b: number, c: number) => void;
export const emulator_sram_region: (a: number) => [number, number];
export const emulator_step: (a: number) => void;
export const emulator_usart_rx: (a: number, b: number) => void;
export const emulator_usart_status: (a: number) => number;
